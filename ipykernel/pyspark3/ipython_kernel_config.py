...
##
c.IPythonKernel.help_links = [{'text': 'Python Reference', 'url': 'https://docs.python.org/3.8'}, {'text': 'IPython Reference', 'url': 'https://ipython.org/documentation.html'}, {'text': 'NumPy Reference', 'url': 'https://docs.scipy.org/doc/numpy/reference/'}, {'text': 'SciPy Reference', 'url': 'https://docs.scipy.org/doc/scipy/reference/'}, {'text': 'Matplotlib Reference', 'url': 'https://matplotlib.org/contents.html'}, {'text': 'SymPy Reference', 'url': 'http://docs.sympy.org/latest/index.html'}, {'text': 'pandas Reference', 'url': 'https://pandas.pydata.org/pandas-docs/stable/'}, {'text': 'pyspark', 'url': 'http://spark.apache.org/docs/latest/api/python/index.html'}, {'text': 'koalas', 'url': 'https://koalas.readthedocs.io/en/latest/'}]
...
#c.InteractiveShell.banner1 = "Python 3.8.5 | packaged by conda-forge | (default, Jul 31 2020, 02:39:48) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.17.0 -- An enhanced Interactive Python. Type '?' for help.\n"
